...
(function(a){if(typeof define==="function"&&define.amd){define(["jquery"],a)}else{a(jQuery)}})(function(s,j){var c=6,e=s.event.add,v=s.event.remove,y=function(R,Q,S){s.event.trigger(Q,S,R)},C=(function(){return(window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(R,Q){return window.setTimeout(function(){R()},25)})})(),g={textarea:true,input:true,select:true,button:true},i={move:"mousemove",cancel:"mouseup dragstart",end:"mouseup"},d={move:"touchmove",cancel:"touchend",end:"touchend"};function n(S){var U=S,T=false,Q=false;function R(V){if(T){U();C(R);Q=true;T=false}else{Q=false}}this.kick=function(V){T=true;if(!Q){R()}};this.end=function(W){var V=U;if(!W){return}if(!Q){W()}else{U=T?function(){V();W()}:W;T=true}}}function K(){return true}function P(){return false}function B(Q){Q.preventDefault()}function N(Q){if(g[Q.target.tagName.toLowerCase()]){return}Q.preventDefault()}function F(Q){return(Q.which===1&&!Q.ctrlKey&&!Q.altKey)}function L(S,T){var R,Q;if(S.identifiedTouch){return S.identifiedTouch(T)}R=-1;Q=S.length;while(++R<Q){if(S[R].identifier===T){return S[R]}}}function l(R,Q){var S=L(R.changedTouches,Q.identifier);if(!S){return}if(S.pageX===Q.pageX&&S.pageY===Q.pageY){return}return S}function o(R){var Q;if(!F(R)){return}Q={target:R.target,startX:R.pageX,startY:R.pageY,timeStamp:R.timeStamp};e(document,i.move,u,Q);e(document,i.cancel,x,Q)}function u(R){var Q=R.data;r(R,Q,R,z)}function x(Q){z()}function z(){v(document,i.move,u);v(document,i.cancel,z)}function O(R){var S,Q;if(g[R.target.tagName.toLowerCase()]){return}S=R.changedTouches[0];Q={target:S.target,startX:S.pageX,startY:S.pageY,timeStamp:R.timeStamp,identifier:S.identifier};e(document,d.move+"."+S.identifier,p,Q);e(document,d.cancel+"."+S.identifier,D,Q)}function p(R){var Q=R.data,S=l(R,Q);if(!S){return}r(R,Q,S,M)}function D(R){var Q=R.data,S=L(R.changedTouches,Q.identifier);if(!S){return}M(Q.identifier)}function M(Q){v(document,"."+Q,p);v(document,"."+Q,D)}function r(U,T,V,S){var R=V.pageX-T.startX,Q=V.pageY-T.startY;if((R*R)+(Q*Q)<(c*c)){return}q(U,T,V,R,Q,S)}function H(){this._handled=K;return false}function J(Q){Q._handled()}function q(U,Y,S,X,V,W){var R=Y.target,T,Q;T=U.targetTouches;Q=U.timeStamp-Y.timeStamp;Y.type="movestart";Y.distX=X;Y.distY=V;Y.deltaX=X;Y.deltaY=V;Y.pageX=S.pageX;Y.pageY=S.pageY;Y.velocityX=X/Q;Y.velocityY=V/Q;Y.targetTouches=T;Y.finger=T?T.length:1;Y._handled=H;Y._preventTouchmoveDefault=function(){U.preventDefault()};y(Y.target,Y);W(Y.identifier)}function G(R){var Q=R.data.event,S=R.data.timer;E(Q,R,R.timeStamp,S)}function b(R){var Q=R.data.event,S=R.data.timer;a();w(Q,S,function(){setTimeout(function(){v(Q.target,"click",P)},0)})}function a(Q){v(document,i.move,G);v(document,i.end,b)}function A(R){var Q=R.data.event,T=R.data.timer,S=l(R,Q);if(!S){return}R.preventDefault();Q.targetTouches=R.targetTouches;E(Q,S,R.timeStamp,T)}function h(R){var Q=R.data.event,T=R.data.timer,S=L(R.changedTouches,Q.identifier);if(!S){return}k(Q);w(Q,T)}function k(Q){v(document,"."+Q.identifier,A);v(document,"."+Q.identifier,h)}function E(R,U,Q,T){var S=Q-R.timeStamp;R.type="move";R.distX=U.pageX-R.startX;R.distY=U.pageY-R.startY;R.deltaX=U.pageX-R.pageX;R.deltaY=U.pageY-R.pageY;R.velocityX=0.3*R.velocityX+0.7*R.deltaX/S;R.velocityY=0.3*R.velocityY+0.7*R.deltaY/S;R.pageX=U.pageX;R.pageY=U.pageY;T.kick()}function w(R,S,Q){S.end(function(){R.type="moveend";y(R.target,R);return Q&&Q()})}function f(S,R,Q){e(this,"movestart.move",J);return true}function t(Q){v(this,"dragstart drag",B);v(this,"mousedown touchstart",N);v(this,"movestart",J);return true}function I(Q){if(Q.namespace==="move"||Q.namespace==="moveend"){return}e(this,"dragstart."+Q.guid+" drag."+Q.guid,B,j,Q.selector);e(this,"mousedown."+Q.guid,N,j,Q.selector)}function m(Q){if(Q.namespace==="move"||Q.namespace==="moveend"){return}v(this,"dragstart."+Q.guid+" drag."+Q.guid);v(this,"mousedown."+Q.guid)}s.event.special.movestart={setup:f,teardown:t,add:I,remove:m,_default:function(S){var Q,R;if(!S._handled()){return}Q={target:S.target,startX:S.startX,startY:S.startY,pageX:S.pageX,pageY:S.pageY,distX:S.distX,distY:S.distY,deltaX:S.deltaX,deltaY:S.deltaY,velocityX:S.velocityX,velocityY:S.velocityY,timeStamp:S.timeStamp,identifier:S.identifier,targetTouches:S.targetTouches,finger:S.finger};R={event:Q,timer:new n(function(T){y(S.target,Q)})};if(S.identifier===j){e(S.target,"click",P);e(document,i.move,G,R);e(document,i.end,b,R)}else{S._preventTouchmoveDefault();e(document,d.move+"."+S.identifier,A,R);e(document,d.end+"."+S.identifier,h,R)}}};s.event.special.move={setup:function(){e(this,"movestart.move",s.noop)},teardown:function(){v(this,"movestart.move",s.noop)}};s.event.special.moveend={setup:function(){e(this,"movestart.moveend",s.noop)},teardown:function(){v(this,"movestart.moveend",s.noop)}};e(document,"mousedown.move",o);e(document,"touchstart.move",O);if(typeof Array.prototype.indexOf==="function"){(function(S,T){var R=["changedTouches","targetTouches"],Q=R.length;while(Q--){if(S.event.props.indexOf(R[Q])===-1){S.event.props.push(R[Q])}}})(s)}});(function(a){if(typeof define==="function"&&define.amd){define(["jquery"],a)}else{a(jQuery)}})(function(g,h){var f=g.event.add,c=g.event.remove,d=function(j,i,k){g.event.trigger(i,k,j)},e={threshold:0.4,sensitivity:6};function b(l){var i,j,k;i=l.target.offsetWidth;j=l.target.offsetHeight;k={distX:l.distX,distY:l.distY,velocityX:l.velocityX,velocityY:l.velocityY,finger:l.finger};if(l.distX>l.distY){if(l.distX>-l.distY){if(l.distX/i>e.threshold||l.velocityX*l.distX/i*e.sensitivity>1){k.type="swiperight";d(l.currentTarget,k)}}else{if(-l.distY/j>e.threshold||l.velocityY*l.distY/i*e.sensitivity>1){k.type="swipeup";d(l.currentTarget,k)}}}else{if(l.distX>-l.distY){if(l.distY/j>e.threshold||l.velocityY*l.distY/i*e.sensitivity>1){k.type="swipedown";d(l.currentTarget,k)}}else{if(-l.distX/i>e.threshold||l.velocityX*l.distX/i*e.sensitivity>1){k.type="swipeleft";d(l.currentTarget,k)}}}}function a(i){var j=g.data(i,"event_swipe");if(!j){j={count:0};g.data(i,"event_swipe",j)}return j}g.event.special.swipe=g.event.special.swipeleft=g.event.special.swiperight=g.event.special.swipeup=g.event.special.swipedown={setup:function(k,j,i){var k=a(this);if(k.count++>0){return}f(this,"moveend",b);return true},teardown:function(){var i=a(this);if(--i.count>0){return}c(this,"moveend",b);return true},settings:e}});

/* jquery.event.swipe.js */
(function(a){if(typeof define==="function"&&define.amd){define(["jquery"],a)}else{a(jQuery)}})(function(g,h){var f=g.event.add,c=g.event.remove,d=function(j,i,k){g.event.trigger(i,k,j)},e={threshold:0.4,sensitivity:6};function b(l){var i,j,k;i=l.target.offsetWidth;j=l.target.offsetHeight;k={distX:l.distX,distY:l.distY,velocityX:l.velocityX,velocityY:l.velocityY,finger:l.finger};if(l.distX>l.distY){if(l.distX>-l.distY){if(l.distX/i>e.threshold||l.velocityX*l.distX/i*e.sensitivity>1){k.type="swiperight";d(l.currentTarget,k)}}else{if(-l.distY/j>e.threshold||l.velocityY*l.distY/i*e.sensitivity>1){k.type="swipeup";d(l.currentTarget,k)}}}else{if(l.distX>-l.distY){if(l.distY/j>e.threshold||l.velocityY*l.distY/i*e.sensitivity>1){k.type="swipedown";d(l.currentTarget,k)}}else{if(-l.distX/i>e.threshold||l.velocityX*l.distX/i*e.sensitivity>1){k.type="swipeleft";d(l.currentTarget,k)}}}}function a(i){var j=g.data(i,"event_swipe");if(!j){j={count:0};g.data(i,"event_swipe",j)}return j}g.event.special.swipe=g.event.special.swipeleft=g.event.special.swiperight=g.event.special.swipeup=g.event.special.swipedown={setup:function(k,j,i){var k=a(this);if(k.count++>0){return}f(this,"moveend",b);return true},teardown:function(){var i=a(this);if(--i.count>0){return}c(this,"moveend",b);return true},settings:e}});

/* jquery.foundation.accordion.js */
(function(b,a,c){b.fn.foundationAccordion=function(d){var e=b(".accordion");if(e.hasClass("hover")&&!Modernizr.touch){b(".accordion li",this).on({mouseenter:function(){console.log("due");var g=b(this).parent(),f=b(this).children(".content").first();b(".content",g).not(f).hide().parent("li").removeClass("active");f.show(0,function(){f.parent("li").addClass("active")})}})}else{b(".accordion li",this).on("click.fndtn",function(){var f=b(this),h=b(this).parent(),g=b(this).children(".content").first();if(f.hasClass("active")){h.find("li").removeClass("active").end().find(".content").hide()}else{b(".content",h).not(g).hide().parent("li").removeClass("active");g.show(0,function(){g.parent("li").addClass("active")})}})}}})(jQuery,this);

/* jquery.foundation.alerts.js */
(function(b,a,c){b.fn.foundationAlerts=function(d){var e=b.extend({callback:b.noop},d);b(document).on("click",".alert-box a.close",function(f){f.preventDefault();b(this).closest(".alert-box").fadeOut(function(){b(this).remove();e.callback()})})}})(jQuery,this);

/* jquery.foundation.buttons.js */
(function(b,a,c){b.fn.foundationButtons=function(l){var g=b(document),e=b.extend({dropdownAsToggle:true,activeClass:"active"},l),f=function(m){b(".button.dropdown").find("ul").not(m).removeClass("show-dropdown")},i=function(m){var n=b(".button.dropdown").not(m);n.add(b("> span."+e.activeClass,n)).removeClass(e.activeClass)};g.on("click.fndtn",".button.disabled",function(m){m.preventDefault()});b(".button.dropdown > ul",this).addClass("no-hover");g.on("click.fndtn",".button.dropdown:not(.split), .button.dropdown.split span",function(o){var n=b(this),m=n.closest(".button.dropdown"),p=b("> ul",m);if(o.target.nodeName!=="A"){o.preventDefault()}f(e.dropdownAsToggle?p:"");p.toggleClass("show-dropdown");if(e.dropdownAsToggle){i(m);n.toggleClass(e.activeClass)}});g.on("click.fndtn","body, html",function(m){if(c==m.originalEvent){return}if(!b(m.originalEvent.target).is(".button.dropdown:not(.split), .button.dropdown.split span")){f();if(e.dropdownAsToggle){i()}}});var h=b(".button.dropdown:not(.large):not(.small):not(.tiny)",this).outerHeight()-1,k=b(".button.large.dropdown",this).outerHeight()-1,d=b(".button.small.dropdown",this).outerHeight()-1,j=b(".button.tiny.dropdown",this).outerHeight()-1;b(".button.dropdown:not(.large):not(.small):not(.tiny) > ul",this).css("top",h);b(".button.dropdown.large > ul",this).css("top",k);b(".button.dropdown.small > ul",this).css("top",d);b(".button.dropdown.tiny > ul",this).css("top",j);b(".button.dropdown.up:not(.large):not(.small):not(.tiny) > ul",this).css("top","auto").css("bottom",h-2);b(".button.dropdown.up.large > ul",this).css("top","auto").css("bottom",k-2);b(".button.dropdown.up.small > ul",this).css("top","auto").css("bottom",d-2);b(".button.dropdown.up.tiny > ul",this).css("top","auto").css("bottom",j-2)}})(jQuery,this);

/* jquery.foundation.clearing.js */
(function(d,c,f){var e={templates:{viewing:'<a href="#" class="clearing-close">&times;</a><div class="visible-img" style="display: none"><img src="#"><p class="clearing-caption"></p><a href="#" class="clearing-main-left"></a><a href="#" class="clearing-main-right"></a></div>'},initialized:false,locked:false},b={},a={init:function(g,h){return this.find("ul[data-clearing]").each(function(){var l=d(document),j=d(this),i=i||{},m=m||{},k=j.data("fndtn.clearing.settings");if(!k){i.$parent=j.parent();j.data("fndtn.clearing.settings",d.extend({},e,i));a.extend(a,m);a.assemble(j.find("li"));if(!e.initialized){a.events()}}})},events:function(){var g=d(document);g.on("click.fndtn.clearing","ul[data-clearing] li",function(k,j,i){var j=j||d(this),i=i||j,h=j.parent().data("fndtn.clearing.settings");k.preventDefault();if(!h){j.parent().foundationClearing()}a.open(d(k.target),j,i);a.update_paddles(i)});d(c).on("resize.fndtn.clearing",function(){var h=d(".clearing-blackout .visible-img").find("img");if(h.length>0){a.center(h)}});g.on("click.fndtn.clearing",".clearing-main-right",function(i){var h=d(".clearing-blackout").find("ul[data-clearing]");i.preventDefault();a.go(h,"next")});g.on("click.fndtn.clearing",".clearing-main-left",function(i){var h=d(".clearing-blackout").find("ul[data-clearing]");i.preventDefault();a.go(h,"prev")});g.on("click.fndtn.clearing","a.clearing-close, div.clearing-blackout, div.visible-img",function(k){var i=(function(l){if(/blackout/.test(l.selector)){return l}else{return l.closest(".clearing-blackout")}}(d(this))),h,j;if(this===k.target&&i){h=i.find("div:first"),j=h.find(".visible-img");e.prev_index=0;i.find("ul[data-clearing]").attr("style","");i.removeClass("clearing-blackout");h.removeClass("clearing-container");j.hide()}return false});g.on("keydown.fndtn.clearing",function(i){var h=d(".clearing-blackout").find("ul[data-clearing]");if(i.which===39){a.go(h,"next")}if(i.which===37){a.go(h,"prev")}if(i.which===27){d("a.clearing-close").trigger("click")}});g.on("movestart",function(h){if((h.distX>h.distY&&h.distX<-h.distY)||(h.distX<h.distY&&h.distX>-h.distY)){h.preventDefault()}});g.bind("swipeleft","ul[data-clearing] li",function(){var h=d(".clearing-blackout").find("ul[data-clearing]");a.go(h,"next")});g.bind("swiperight","ul[data-clearing] li",function(){var h=d(".clearing-blackout").find("ul[data-clearing]");a.go(h,"prev")});e.initialized=true},assemble:function(l){var h=l.parent(),i=h.data("fndtn.clearing.settings"),g=h.detach(),j={grid:'<div class="carousel">'+this.outerHTML(g[0])+"</div>",viewing:i.templates.viewing},k='<div class="clearing-assembled"><div>'+j.viewing+j.grid+"</div></div>";return i.$parent.append(k)},open:function(j,m,l){var h=l.closest(".clearing-assembled"),g=h.find("div:first"),i=g.find(".visible-img"),k=i.find("img").not(j);if(!a.locked()){k.attr("src",this.load(j));k.is_good(function(){h.addClass("clearing-blackout");g.addClass("clearing-container");a.caption(i.find(".clearing-caption"),j);i.show();a.fix_height(l);a.center(k);a.shift(m,l,function(){l.siblings().removeClass("visible");l.addClass("visible")})})}},fix_height:function(h){var g=h.siblings();g.each(function(){var i=d(this),j=i.find("img");if(i.height()>j.outerHeight()){i.addClass("fix-height")}});g.closest("ul").width(g.length*100+"%")},update_paddles:function(h){var g=h.closest(".carousel").siblings(".visible-img");if(h.next().length>0){g.find(".clearing-main-right").removeClass("disabled")}else{g.find(".clearing-main-right").addClass("disabled")}if(h.prev().length>0){g.find(".clearing-main-left").removeClass("disabled")}else{g.find(".clearing-main-left").addClass("disabled")}},load:function(h){var g=h.parent().attr("href");this.preload(h);if(g){return g}return h.attr("src")},preload:function(k){var j=k.closest("li").next(),l=k.closest("li").prev(),m,i,g,h;if(j.length>0){g=new Image();m=j.find("a");if(m.length>0){g.src=m.attr("href")}else{g.src=j.find("img").attr("src")}}if(l.length>0){h=new Image();i=l.find("a");if(i.length>0){h.src=i.attr("href")}else{h.src=l.find("img").attr("src")}}},caption:function(g,i){var h=i.data("caption");if(h){g.text(h).show()}else{g.text("").hide()}},go:function(g,j){var i=g.find(".visible"),h=i[j]();if(h.length>0){h.find("img").trigger("click",[i,h])}},shift:function(l,m,r){var o=m.parent(),g=o.closest(".clearing-container"),n=m.position().left,j=o.position().left,k=e.prev_index,p=this.direction(o,l,m),i=parseInt(o.css("left"),10),h=m.outerWidth(),q;if(m.index()!==k&&!/skip/.test(p)){if(/left/.test(p)){a.lock();o.animate({left:i+h},300,a.unlock)}else{if(/right/.test(p)){a.lock();o.animate({left:i-h},300,a.unlock)}}}else{if(/skip/.test(p)){q=m.index()-e.up_count;a.lock();if(q>0){o.animate({left:-(q*h)},300,a.unlock)}else{o.animate({left:0},300,a.unlock)}}}r()},lock:function(){e.locked=true},unlock:function(){e.locked=false},locked:function(){return e.locked},direction:function(q,m,n){var p=q.find("li"),o=p.outerWidth()+(p.outerWidth()/4),i=d(".clearing-container"),l=Math.floor(i.outerWidth()/o)-1,j=p.length-l,h=p.index(n),g=p.index(m),k;e.up_count=l;if(this.adjacent(e.prev_index,h)){if((h>l)&&h>e.prev_index){k="right"}else{if((h>l-1)&&h<=e.prev_index){k="left"}else{k=false}}}else{k="skip"}e.prev_index=h;return k},adjacent:function(h,g){if(g-1===h){return true}else{if(g+1===h){return true}else{if(g===h){return true}}}return false},center:function(g){g.css({marginLeft:-(g.outerWidth()/2),marginTop:-(g.outerHeight()/2)})},outerHTML:function(g){return g.outerHTML||new XMLSerializer().serializeToString(g)},extend:function(g,h){d.each(g,function(i,j){if(h.hasOwnProperty(i)){b[i]=j}});d.extend(a,h)},_super:function(h,g){return b[h].apply(this,g)}};d.fn.foundationClearing=function(g){if(a[g]){return a[g].apply(this,Array.prototype.slice.call(arguments,1))}else{if(typeof g==="object"||!g){return a.init.apply(this,arguments)}else{d.error("Method "+g+" does not exist on jQuery.foundationClearing")}}};(function(g){g.fn.is_good=function(n,l){var j=g.extend({},g.fn.is_good.defaults,l),i=this.find("img").add(this.filter("img")),k=i.length;function h(){k-=1;!k&&n()}function m(){this.one("load",h);if(g.browser.msie){var p=this.attr("src"),o=p.match(/\?/)?"&":"?";o+=j.cachePrefix+"="+(new Date()).getTime();this.attr("src",p+o)}}return i.each(function(){var o=g(this);if(!o.attr("src")){h();return}this.complete||this.readyState===4?h():m.call(o)})};g.fn.is_good.defaults={cachePrefix:"random"}}(jQuery))}(jQuery,this));
...
(function(d,c,g){var f={version:"2.0.1",tipLocation:"bottom",nubPosition:"auto",scrollSpeed:300,timer:0,startTimerOnClick:true,startOffset:0,nextButton:true,tipAnimation:"fade",pauseAfter:[],tipAnimationFadeSpeed:300,cookieMonster:false,cookieName:"joyride",cookieDomain:false,tipContainer:"body",postRideCallback:d.noop,postStepCallback:d.noop,template:{link:'<a href="#close" class="joyride-close-tip">X</a>',timer:'<div class="joyride-timer-indicator-wrap"><span class="joyride-timer-indicator"></span></div>',tip:'<div class="joyride-tip-guide"><span class="joyride-nub"></span></div>',wrapper:'<div class="joyride-content-wrapper"></div>',button:'<a href="#" class="small button joyride-next-tip"></a>'}},e=e||false,b={},a={init:function(h){return this.each(function(){if(d.isEmptyObject(b)){b=d.extend(f,h);b.document=c.document;b.$document=d(b.document);b.$window=d(c);b.$content_el=d(this);b.body_offset=d(b.tipContainer).position();b.$tip_content=d("> li",b.$content_el);b.paused=false;b.attempts=0;b.tipLocationPatterns={top:["bottom"],bottom:[],left:["right","top","bottom"],right:["left","top","bottom"]};a.jquery_check();if(!d.isFunction(d.cookie)){b.cookieMonster=false}if(!b.cookieMonster||!d.cookie(b.cookieName)){b.$tip_content.each(function(i){a.create({$li:d(this),index:i})});if(!b.startTimerOnClick&&b.timer>0){a.show("init");a.startTimer()}else{a.show("init")}}b.$document.on("click.joyride",".joyride-next-tip, .joyride-modal-bg",function(i){i.preventDefault();if(b.$li.next().length<1){a.end()}else{if(b.timer>0){clearTimeout(b.automate);a.hide();a.show();a.startTimer()}else{a.hide();a.show()}}});b.$document.on("click.joyride",".joyride-close-tip",function(i){i.preventDefault();a.end()});b.$window.bind("resize.joyride",function(i){if(a.is_phone()){a.pos_phone()}else{a.pos_default()}})}else{a.restart()}})},resume:function(){a.set_li();a.show()},tip_template:function(i){var j,h;i.tip_class=i.tip_class||"";j=d(b.template.tip).addClass(i.tip_class);h=d.trim(d(i.li).html())+a.button_text(i.button_text)+b.template.link+a.timer_instance(i.index);j.append(d(b.template.wrapper));j.first().attr("data-index",i.index);d(".joyride-content-wrapper",j).append(h);return j[0]},timer_instance:function(i){var h;if((i===0&&b.startTimerOnClick&&b.timer>0)||b.timer===0){h=""}else{h=a.outerHTML(d(b.template.timer)[0])}return h},button_text:function(h){if(b.nextButton){h=d.trim(h)||"Next";h=a.outerHTML(d(b.template.button).append(h)[0])}else{h=""}return h},create:function(j){var i=j.$li.attr("data-button")||j.$li.attr("data-text"),h=j.$li.attr("class"),k=d(a.tip_template({tip_class:h,index:j.index,button_text:i,li:j.$li}));d(b.tipContainer).append(k)},show:function(n){var k={},j,i=[],h=0,m,l=null;if(b.$li===g||(d.inArray(b.$li.index(),b.pauseAfter)===-1)){if(b.paused){b.paused=false}else{a.set_li(n)}b.attempts=0;if(b.$li.length&&b.$target.length>0){i=(b.$li.data("options")||":").split(";");h=i.length;for(j=h-1;j>=0;j--){m=i[j].split(":");if(m.length===2){k[d.trim(m[0])]=d.trim(m[1])}}b.tipSettings=d.extend({},b,k);b.tipSettings.tipLocationPattern=b.tipLocationPatterns[b.tipSettings.tipLocation];if(!/body/i.test(b.$target.selector)){a.scroll_to()}if(a.is_phone()){a.pos_phone(true)}else{a.pos_default(true)}l=d(".joyride-timer-indicator",b.$next_tip);if(/pop/i.test(b.tipAnimation)){l.outerWidth(0);if(b.timer>0){b.$next_tip.show();l.animate({width:d(".joyride-timer-indicator-wrap",b.$next_tip).outerWidth()},b.timer)}else{b.$next_tip.show()}}else{if(/fade/i.test(b.tipAnimation)){l.outerWidth(0);if(b.timer>0){b.$next_tip.fadeIn(b.tipAnimationFadeSpeed);b.$next_tip.show();l.animate({width:d(".joyride-timer-indicator-wrap",b.$next_tip).outerWidth()},b.timer)}else{b.$next_tip.fadeIn(b.tipAnimationFadeSpeed)}}}b.$current_tip=b.$next_tip}else{if(b.$li&&b.$target.length<1){a.show()}else{a.end()}}}else{b.paused=true}},is_phone:function(){if(e){return e.mq("only screen and (max-width: 767px)")}return(b.$window.width()<767)?true:false},hide:function(){b.postStepCallback(b.$li.index(),b.$current_tip);d(".joyride-modal-bg").hide();b.$current_tip.hide()},set_li:function(h){if(h){b.$li=b.$tip_content.eq(b.startOffset);a.set_next_tip();b.$current_tip=b.$next_tip}else{b.$li=b.$li.next();a.set_next_tip()}a.set_target()},set_next_tip:function(){b.$next_tip=d(".joyride-tip-guide[data-index="+b.$li.index()+"]")},set_target:function(){var h=b.$li.attr("data-class"),j=b.$li.attr("data-id"),i=function(){if(j){return d(b.document.getElementById(j))}else{if(h){return d("."+h).first()}else{return d("body")}}};b.$target=i()},scroll_to:function(){var i,h;i=b.$window.height()/2;h=Math.ceil(b.$target.offset().top-i+b.$next_tip.outerHeight());d("html, body").stop().animate({scrollTop:h},b.scrollSpeed)},paused:function(){if((d.inArray((b.$li.index()+1),b.pauseAfter)===-1)){return true}return false},destroy:function(){b.$document.off(".joyride");d(c).off(".joyride");d(".joyride-close-tip, .joyride-next-tip, .joyride-modal-bg").off(".joyride");d(".joyride-tip-guide, .joyride-modal-bg").remove();clearTimeout(b.automate);b={}},restart:function(){a.hide();b.$li=g;a.show("init")},pos_default:function(l){var i=Math.ceil(b.$window.height()/2),k=b.$next_tip.offset(),j=d(".joyride-nub",b.$next_tip),m=Math.ceil(j.outerHeight()/2),h=l||false;if(h){b.$next_tip.css("visibility","hidden");b.$next_tip.show()}if(!/body/i.test(b.$target.selector)){if(a.bottom()){b.$next_tip.css({top:(b.$target.offset().top+m+b.$target.outerHeight()),left:b.$target.offset().left});a.nub_position(j,b.tipSettings.nubPosition,"top")}else{if(a.top()){b.$next_tip.css({top:(b.$target.offset().top-b.$next_tip.outerHeight()-m),left:b.$target.offset().left});a.nub_position(j,b.tipSettings.nubPosition,"bottom")}else{if(a.right()){b.$next_tip.css({top:b.$target.offset().top,left:(b.$target.outerWidth()+b.$target.offset().left)});a.nub_position(j,b.tipSettings.nubPosition,"left")}else{if(a.left()){b.$next_tip.css({top:b.$target.offset().top,left:(b.$target.offset().left-b.$next_tip.outerWidth()-m)});a.nub_position(j,b.tipSettings.nubPosition,"right")}}}}if(!a.visible(a.corners(b.$next_tip))&&b.attempts<b.tipSettings.tipLocationPattern.length){j.removeClass("bottom").removeClass("top").removeClass("right").removeClass("left");b.tipSettings.tipLocation=b.tipSettings.tipLocationPattern[b.attempts];b.attempts++;a.pos_default(true)}}else{if(b.$li.length){a.pos_modal(j)}}if(h){b.$next_tip.hide();b.$next_tip.css("visibility","visible")}},pos_phone:function(m){var l=b.$next_tip.outerHeight(),k=b.$next_tip.offset(),j=b.$target.outerHeight(),i=d(".joyride-nub",b.$next_tip),n=Math.ceil(i.outerHeight()/2),h=m||false;i.removeClass("bottom").removeClass("top").removeClass("right").removeClass("left");if(h){b.$next_tip.css("visibility","hidden");b.$next_tip.show()}if(!/body/i.test(b.$target.selector)){if(a.top()){b.$next_tip.offset({top:b.$target.offset().top-l-n});i.addClass("bottom")}else{b.$next_tip.offset({top:b.$target.offset().top+j+n});i.addClass("top")}}else{if(b.$li.length){a.pos_modal(i)}}if(h){b.$next_tip.hide();b.$next_tip.css("visibility","visible")}},pos_modal:function(h){a.center();h.hide();if(d(".joyride-modal-bg").length<1){d("body").append('<div class="joyride-modal-bg">').show()}if(/pop/i.test(b.tipAnimation)){d(".joyride-modal-bg").show()}else{d(".joyride-modal-bg").fadeIn(b.tipAnimationFadeSpeed)}},center:function(){var h=b.$window;b.$next_tip.css({top:(((h.height()-b.$next_tip.outerHeight())/2)+h.scrollTop()),left:(((h.width()-b.$next_tip.outerWidth())/2)+h.scrollLeft())});return true},bottom:function(){return/bottom/i.test(b.tipSettings.tipLocation)},top:function(){return/top/i.test(b.tipSettings.tipLocation)},right:function(){return/right/i.test(b.tipSettings.tipLocation)},left:function(){return/left/i.test(b.tipSettings.tipLocation)},corners:function(k){var h=b.$window,j=h.width()+h.scrollLeft(),i=h.width()+h.scrollTop();return[k.offset().top<=h.scrollTop(),j<=k.offset().left+k.outerWidth(),i<=k.offset().top+k.outerHeight(),h.scrollLeft()>=k.offset().left]},visible:function(h){var j=h.length;while(j--){if(h[j]){return false}}return true},nub_position:function(h,j,i){if(j==="auto"){h.addClass(i)}else{h.addClass(j)}},startTimer:function(){if(b.$li.length){b.automate=setTimeout(function(){a.hide();a.show();a.startTimer()},b.timer)}else{clearTimeout(b.automate)}},end:function(){if(b.cookieMonster){d.cookie(b.cookieName,"ridden",{expires:365,domain:b.cookieDomain})}if(b.timer>0){clearTimeout(b.automate)}d(".joyride-modal-bg").hide();b.$current_tip.hide();b.postStepCallback(b.$li.index(),b.$current_tip);b.postRideCallback(b.$li.index(),b.$current_tip)},jquery_check:function(){if(!d.isFunction(d.fn.on)){d.fn.on=function(h,j,i){return this.delegate(j,h,i)};d.fn.off=function(h,j,i){return this.undelegate(j,h,i)};return false}return true},outerHTML:function(h){return h.outerHTML||new XMLSerializer().serializeToString(h)},version:function(){return b.version}};d.fn.joyride=function(h){if(a[h]){return a[h].apply(this,Array.prototype.slice.call(arguments,1))}else{if(typeof h==="object"||!h){return a.init.apply(this,arguments)}else{d.error("Method "+h+" does not exist on jQuery.joyride")}}}}(jQuery,this));

/* jquery.foundation.magellan.js */
(function(b,a,c){b.fn.foundationMagellan=function(d){var g=b("[data-magellan-expedition=fixed]"),f={threshold:(g.length)?g.outerHeight(true):25,activeClass:"active"},d=b.extend({},f,d);b(document).on("magellan.arrival","[data-magellan-arrival]",function(j){var i=b(this).closest("[data-magellan-expedition]"),h=i.attr("data-magellan-active-class")||d.activeClass;b(this).closest("[data-magellan-expedition]").find("[data-magellan-arrival]").not(this).removeClass(h);b(this).addClass(h)});var e=b("[data-magellan-expedition]");e.find("[data-magellan-arrival]:first").addClass(e.attr("data-magellan-active-class")||d.activeClass);g.on("magellan.update-position",function(){var h=b(this);h.data("magellan-fixed-position","");h.data("magellan-top-offset","")});g.trigger("magellan.update-position");b(a).on("resize.magellan",function(){g.trigger("magellan.update-position")});b(a).on("scroll.magellan",function(){var h=b(a).scrollTop();g.each(function(){var i=b(this);if(i.data("magellan-top-offset")===""){i.data("magellan-top-offset",i.offset().top)}var j=(h+d.threshold)>i.data("magellan-top-offset");if(i.data("magellan-fixed-position")!=j){i.data("magellan-fixed-position",j);if(j){i.css({position:"fixed",top:0})}else{i.css({position:"",top:""})}}})});b(a).on("scroll.magellan",function(i){var h=b(a).scrollTop();b("[data-magellan-destination]").each(function(){var l=b(this),k=l.attr("data-magellan-destination"),j=l.offset().top-h;if(j<=d.threshold){b("[data-magellan-arrival="+k+"]").trigger("magellan.arrival")}})})}}(jQuery,this));

/* jquery.foundation.mediaQueryToggle.js */
(function(b,a,c){b.fn.foundationMediaQueryViewer=function(d){var e=b.extend(d,{toggleKey:77}),f=b(document);f.on("keyup.mediaQueryViewer",":input",function(g){if(g.which===e.toggleKey){g.stopPropagation()}});f.on("keyup.mediaQueryViewer",function(g){var h=b("#fqv");if(g.which===e.toggleKey){if(h.length>0){h.remove()}else{b("body").prepend('<div id="fqv" style="position:fixed;top:4px;left:4px;z-index:999;color:#fff;"><p style="font-size:12px;background:rgba(0,0,0,0.75);padding:5px;margin-bottom:1px;line-height:1.2;"><span class="left">Media:</span> <span style="font-weight:bold;" class="show-for-xlarge">Extra Large</span><span style="font-weight:bold;" class="show-for-large">Large</span><span style="font-weight:bold;" class="show-for-medium">Medium</span><span style="font-weight:bold;" class="show-for-small">Small</span><span style="font-weight:bold;" class="show-for-landscape">Landscape</span><span style="font-weight:bold;" class="show-for-portrait">Portrait</span><span style="font-weight:bold;" class="show-for-touch">Touch</span></p></div>')}}})}})(jQuery,this);
...
/* jquery.offcanvas.js */
(function(d,a,e){var h=e("#topMenu"),b="click.fndtn";if(h.length>0){h.css("margin-top",h.height()*-1)}var g=e("#sidebarButton");if(g.length>0){e("#sidebarButton").on(b,function(i){i.preventDefault();e("body").toggleClass("active")})}var f=e("#menuButton");if(f.length>0){e("#menuButton").on(b,function(i){i.preventDefault();e("body").toggleClass("active-menu")})}var c=e("#switchPanels");if(c.length>0){e("#switchPanels dd").on(b,function(j){j.preventDefault();var k=e(this).children("a").attr("href"),i=e(k).index();e(this).toggleClass("active").siblings().removeClass("active");e(k).parent().css("left",(i*(-100)+"%"))})}e("#nav li a").on(b,function(k){k.preventDefault();var j=e(this).attr("href"),i=e(j);e("html, body").animate({scrollTop:i.offset().top},300)})}(this,document,jQuery));
